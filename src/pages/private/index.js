                    ...
                    <Route path="/" exact children={({
                      match, history }) => {
                        return <a
                          key="Dashboard"
                          href="#"
                          className={match ? classNames('bg-gray-900 text-white text-gray-300 hover:bg-gray-700 hover:text-white',
                          'px-3 py-2 rounded-md text-sm font-medium') : classNames('text-gray-300 hover:bg-gray-700 hover:text-white',
